 ...
 * them as 932x932 assets that overhang their box by 63.11% on every side.
 */
function Glow({
  src,
  top,
...
export default function EarlyAccess() {
  return (
    ...
    >
      {/*
       * Ellipses 6150 and 6151 at the size the phone's frame draws them: two 260px
       * circles rather than the 412s the wide layout carries, and placed against the
       * section rather than against the card's slot — the mobile frame puts one off
       * the left edge level with the.
       */}
      {/*
       * The same two roles the wide layout's pair carries, so earlyCard brings them
       * in with the card and glowDrift keeps them shearing across each other
       * afterwards.
       */}
      ...
      <div className="screen-body relative z-10">
        {/*
         * The one section that leads with artwork, so the card takes the flexible slot
         * and the words below it take only what they need — the reverse of everywhere
         * else.
         */}
        <div className="screen-payload px-4 sm:px-6">
          ...
          <div className="stage-viewport stage-viewport-open">
            ...
            >
              <div className="stage">
                {/*
                 * The wrapper, not the card: SquadCard's own root already carries a transform
                 * to scale its face, and the turn belongs to something that owns its transform
                 * outright.
                 */}
        ...
        <div className="screen-copy mx-auto flex max-w-204 flex-col items-center gap-12 px-4 sm:gap-[clamp(1rem,3.2svh,3.75rem)] sm:px-6">
          ...
          <form className="flex w-full flex-col items-center gap-12 sm:gap-[clamp(1rem,3.2svh,3.75rem)]">
            ...
            <div className="flex w-full flex-col items-center gap-4">
              ...
              {/*
               * The wrapper takes the hinge: Button owns its own hover transform, and two
               * owners on one transform collide.
               */}
